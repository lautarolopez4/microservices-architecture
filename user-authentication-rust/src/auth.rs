...
// Importing necessary types and traits from the 'warp' crate
use std::fmt;
use warp::{
...
impl fmt::Display for Role {
    // Implementing Display trait to allow Role enum to be displayed as a string
...
// Function to create a filter with authentication
...
// Function to authorize a user based on JWT token
